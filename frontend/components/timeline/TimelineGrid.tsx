...
export default function TimelineGrid() {
  ...
  if (!data) {
    return (
      <div className="cast-panel cast-shimmer" style={{ height: CONTENT_HEIGHT }} aria-busy />
    );
  }
  ...
  const laneBody = {
    visual: <VisualLane clips={data.lanes.visual} pxPerSecond={pxPerSecond} />,
  ...
  return (
    <div className="cast-panel overflow-hidden">
      <div className="flex">
        {/* Sticky lane labels */}
        <div
